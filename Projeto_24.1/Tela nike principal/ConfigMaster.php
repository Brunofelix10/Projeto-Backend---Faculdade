...
<head>
    ...
    <link rel="stylesheet" href="css/ConfigMaster.css">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
        <div class="container-fluid">
          ...
          <ul class="navbar-nav ml-auto">
              <?php if ($loggedInUser): ?>
                <li class="nav-item">
                    <span class="nav-link">Bem-vindo! <?php echo htmlspecialchars($loggedInUser); ?><br> <div class="type-user">Usuário Master</div></span>
                </li>
                <li class="nav-item">
...
<div class="container-options">
    <div class="options">
        ...
        <a href="exclusao.php" class="option reset">
        ...
        <a href="pag_log.php" class="option reset">
            <span>TELA DE LOG</span>
