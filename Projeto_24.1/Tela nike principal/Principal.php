    ...
    <button type="submit" name="logout" class="logout-button">Sair</button>
      ...
      <div class="video-container">
        <video autoplay muted loop>
            <source src="img/Home Vídeo.mp4" type="video/mp4">
        </video>
    </div>

    <div class="icones-nike">ÍCONES NIKE</div>
<div class="icones-nike-img">
    <a href="#Air-Force-1">
        <img src="img/icones-airforce1.avif" alt="air-force-1">
    </a>
    <a href="#Dunk-Low">
        <img src="img/icones-dunk.avif" alt="dunk">
    </a>
    <a href="#Air-Jordan-1">
        <img src="img/icones-airjordan1.avif" alt="air-jordan-1">
    </a>
</div>

<div class="nike-app">
    <img src="img/Nike app.webp" alt="nike-app">
</div>

<p class="txt-nike">O MUNDO NIKE, DO SEU JEITO.</p>

<div class="nike-app-button">
<a href="https://www.nike.com.br/sc/nike-app" target="_blank">
<button type="button">Baixe o Nike App</button>
</a>
</div>
...
<div class="container-cards-carousel" style="overflow-x: hidden;">
 <div class="container-cards">
  <div class="card">
    <img src="img/Produtos/Camisa Nike Sportswear max90.avif" alt="Sportswear-max90">
    <div class="descricao">Camiseta Nike Sportswear Max90 Masculina</div>
    <div class="precos">
    <div class="preco-oferta">R$ 126,49</div>   
    <div class="preco-original">R$ 229,99</div>
    </div>
    <div class="desconto">45% off</div>
    <button class="botao-comprar">Comprar</button>
  </div>

  <div class="card" id="Air-Jordan-1">
    <img src="img/Produtos/Air Jordan 1 Retro Low OG.avif" alt="Air-Jordan-1-Retro-Low-OG">
    <div class="descricao">Tênis Nike Air Jordan 1 Retro Low OG Red</div>
    <div class="precos">
  ...
  <div class="card">
    <img src="img/Produtos/Jaqueta Nike Sportswea essential Repel.avif" alt="Jaqueta-Sportswear-Repel">
    <div class="descricao">Jaqueta Nike Sportswear Essential Repel Feminina</div>
    <div class="precos">
    <div class="preco-oferta">R$ 246,99</div>   
    <div class="preco-original">R$ 399,99</div>
    </div>
    <div class="desconto">38% off</div>
    <button class="botao-comprar">Comprar</button>
  </div>

  <div class="card">
    <img src="img/Produtos/Chuteira Nike Phantom Luna Elite.avif" alt="Chuteira-Nike-Phantom-Elite">
    <div class="descricao">Chuteira Nike Phantom Luna Elite Campo</div>
    <div class="precos">
    <div class="preco-oferta">R$ 1234,99</div>   
    <div class="preco-original">R$ 2299,99</div>
    </div>
    <div class="desconto">46% off</div>
    <button class="botao-comprar">Comprar</button>
  </div>

  <div class="card" id="Air-Force-1">
    <img src="img/Produtos/Tênis Nike Air Force 1 07 Masculino.avif" alt="Tênis-Nike-Air-Force-1-07-Masculino">
    <div class="descricao">Tênis Nike Air Force 1 "07 Classic Masculino</div>
    <div class="precos">
    <div class="preco-oferta">R$ 495,99</div>   
  ...
  <div class="card" id="Dunk-Low">
    <img src="img/Produtos/Dunk Low.avif" alt="Dunk-Low">
    <div class="descricao"> Tênis Nike Dunk Low Cyan Classic Retro</div>
    <div class="precos">
    <div class="preco-oferta">R$ 584,99</div>   
  ...
  <div class="card">
    <img src="img/Produtos/Nike Air Max AP.avif" alt="Air-Max-AP">
    <div class="descricao">Tênis Nike Air Max AP Masculino Confort</div>
    <div class="precos">
    <div class="preco-oferta">R$ 588,99</div>   
    <div class="preco-original">R$ 899,99</div>
    </div>
    <div class="desconto">35% off</div>
    <button class="botao-comprar">Comprar</button>
  ...
  <div class="card">
    <img src="img/Produtos/Jaqueta Corinthians Hino.avif" alt="Jaqueta-Corinthians-Hino">
    <div class="descricao">Jaqueta Nike Corinthians Masculina Torcedor</div>
    <div class="precos">
    <div class="preco-oferta">R$ 493,99</div>   
...
<div class="junte-se-a-nos">
  <h1 class="junte-se-a-nos-txt"> Junte-se <br> a Nós </h1>
  ...
  <p>Cadastre-se gratuitamente: seja um Membro Nike
        e, de quebra, tenha diversos benefícios.</p>
