...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    // Definindo $perguntas antes de usar
    $perguntas = [
        'nome_materno' => 'Qual o nome Materno?',
        'data_nascimento' => 'Qual a data de nascimento?',
        'cep' => 'Qual o CEP do seu endereço?'
    ...
    // Verifica se a chave da pergunta é válida
    if (array_key_exists($pergunta_chave, $perguntas)) {
        $login = $_SESSION['login'];
        // Use a chave da pergunta para obter o nome da coluna correta
        ...
        if ($resultado->num_rows == 1) {
            ...
            if ($resposta_usuario === $resposta_correta) {
                ...
                unset($_SESSION['2fa']);
                // Registrar tentativa de sucesso no log
